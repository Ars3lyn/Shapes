...
A **class** in C++ is a user-defined data type that serves as a blueprint for creating **objects**. It encapsulates **data members** (variables) and **member functions** (methods) that operate on the data, following the principles of **Object-Oriented Programming (OOP)**.
